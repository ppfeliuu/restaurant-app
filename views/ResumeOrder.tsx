...
const ResumeOrder = () => {
    ...
    const { order, total, showResumen, deleteProduct } = useContext(OrdersContext)
    ...
    return (
        <Container style={globalStyles.contenedor}>
                        ...
                        <List key={id + i}>
                            <ListItem thumbnail>
                                ...
                                <Body>
                                    ...
                                    <Button onPress={() => confirmDelete(id)} full danger style={{marginTop: 20}}>
                                        <Text style={[globalStyles.botonTexto, {color: '#FFF'}]}>Delete</Text>
                                    </Button>
                                </Body>
                            </ListItem>
                        </List>
            ...
            <Button dark full style={{marginTop: 30 }} onPress={() => navigation.navigate('Menu')}>
            ...
            <Footer>
                <FooterTab>
                        <Button full style={[globalStyles.boton]} onPress={() => gotoProgress()}>
